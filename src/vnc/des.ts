...
/* Permutation tables — 1-based indices per DES spec */
...
// PC-2: 56-bit combined key halves → 48-bit subkey
...
export function desEncrypt(block: Buffer, key: Buffer): Buffer {
  const kp = _dperm(_bufToBits(key), _DPC1); // 56 bits
