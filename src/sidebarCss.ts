// ---------------------------------------------------------------------------
// AutoDev AI Tasks — sidebar webview CSS (embedded via nonce <style> tag)
// Edit this file to change sidebar styles. It is imported by sidebar.ts and
// injected into every webview so it always loads regardless of CSP file rules.
// ---------------------------------------------------------------------------
...
.model-select { flex: 1; min-width: 0; cursor: pointer; }
...
/* ── Action buttons (compact, new session, rename) ───────────────────────── */
.new-session-btn {
  margin-left: auto;
  padding: 2px 7px;
  border-radius: 3px;
...
/* ── Add-task form ───────────────────────────────────────────────────────── */
.add-form { display: flex; gap: 5px; margin-bottom: 10px; }
.add-input {
  flex: 1;
  padding: 5px 8px;
  font-size: var(--vscode-font-size);
...
.task.done .task-text { opacity: .4; text-decoration: line-through; }
.task.in-progress {
...
.cfg-check input[type="checkbox"]:focus {
  box-shadow: none;
